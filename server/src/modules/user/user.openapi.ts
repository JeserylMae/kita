...
export const SignupPath: ZodOpenApiPathItemObject  = {
  post: {
    ...
    requestBody: {
      required: true,
      content: { "application/json": { schema: SignupParamsSchema } },
    },
...
export const SigninPath = {
  post: {
    ...
    requestBody: {
      required: true,
      content: { "application/json": { schema: SigninParamsSchema } }
    },
    ...
    parameters: [
      {
        ...
        description: "Indicates that this request is for refreshing the access token.",
        example: "refresh",
      },
    ],
...
export const ResetPasswordPath: ZodOpenApiPathItemObject  = {
  post: {
    ...
    requestBody: {
      required: true,
      content: { "application/json": { schema: ResetPasswordParamsSchema } },
    },
...
export const ForgotPasswordPath: ZodOpenApiPathItemObject = {
  post: {
    ...
    requestBody: {
      required: true,
      content: { "application/json": { schema: ForgotPasswordParamsSchema } }
    },

    responses: {
      202: { description: "Email sent" },
      400: { description: "Invalid request" },
    },
  },
};
...
export const VerifyEmailPath: ZodOpenApiPathItemObject = {
  get: {
    ...
    requestBody: {
      required: true,
      content: {
        "application/json": { schema: z.object({ email: Email }) }
      },
    },
    ...
    responses: {
      200: { description: "Verification email sent if an unverified account exists" },
...
export const ResendEmailVerificationPath: ZodOpenApiPathItemObject = {
  post: {
    ...
    responses: {
      200: { description: "New verification email sent if an unverified account exists" },
      400: { description: "Invalid request" },
    },
  },
};
